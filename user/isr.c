...
{
    interrupt_global_enable(0);                     // 使能中断嵌套
    ...
    // 更新屏幕显示
    balance_control_state_t balance_state;
    balance_control_get_state(&balance_state);
    
    ui_display_data_t ui_data;
    ui_data.angle = balance_state.roll_filtered_deg;
